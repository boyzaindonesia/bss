<script language="javascript" type="text/javascript" src="<?php echo themeUrl(); ?>assets/plugins/tinymce/jquery.tinymce.js"></script>
...
<script language="javascript">
	...
	$(document).ready(function() {
		...
		$('textarea.tinymce').tinymce({
			...
			script_url : "<?php echo themeUrl(); ?>assets/plugins/tinymce/tinymce.js",
			mode : "exact",
			theme : "advanced",
	...
	function ajaxfilemanager(field_name, url, type, win) {
		var ajaxfilemanagerurl = "<?php echo themeUrl(); ?>assets/plugins/tinymce/plugins/ajaxfilemanager/ajaxfilemanager.php";
		switch (type) {
			case "image":
			break;
			case "media":
		...
		tinyMCE.activeEditor.windowManager.open({
			url: "<?php echo themeUrl(); ?>assets/plugins/tinymce/plugins/ajaxfilemanager/ajaxfilemanager.php",
			width: 682,
			height: 400,
			inline : "yes",
			close_previous : "no"
