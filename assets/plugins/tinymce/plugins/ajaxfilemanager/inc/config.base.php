...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_LOGIN_PASSWORD', '123');
	...
	define('CONFIG_SYS_DEFAULT_PATH', CONFIG_BASE_PATH.'uploaded/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', CONFIG_BASE_PATH.'uploaded/');	//accept relative path only
