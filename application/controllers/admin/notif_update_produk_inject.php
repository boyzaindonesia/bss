...
class notif_update_produk_inject extends FrontController {
	function __construct()
	{
		parent::__construct();
        $this->own_link = base_url()."admin/notif_update_produk_inject";
	...
	function index(){
        ...
        $this->load->view('admin/template/notification/notif_update_produk_inject',$data);
	}
