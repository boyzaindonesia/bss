            ...
            <div class="panel-body">
                <div class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="form-control"><?php echo isset($val->headline_title)?$val->headline_title:'';?></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Judul 2</label>
                        <div class="col-sm-9">
                            <div class="form-control"><?php echo isset($val->headline_title_2)?$val->headline_title_2:'';?></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Judul 3</label>
                        <div class="col-sm-9">
                            <div class="form-control"><?php echo isset($val->headline_title_3)?$val->headline_title_3:'';?></div>
                        </div>
                    </div>
                    <div class="form-group hide">
                        <label class="col-sm-3 control-label">Deskripsi</label>
                        <div class="col-sm-9">
                            <div class="form-control"><?php echo isset($val->headline_desc)?$val->headline_desc:'';?></div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5 magnific-popup-wrap">
                            <div class="form-control">
                                <a class="zooming" href="<?php echo get_image(base_url()."assets/collections/headline/large/".$val->headline_images);?>">
                                    <img src="<?php echo get_image(base_url()."assets/collections/headline/large/".$val->headline_images);?>" alt="" class="media-object img-responsive">
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-5 magnific-popup-wrap">
                            <div class="form-control">
                                <a class="zooming" href="<?php echo get_image(base_url()."assets/collections/headline/large/".$val->headline_images_mobile);?>">
                                    <img src="<?php echo get_image(base_url()."assets/collections/headline/large/".$val->headline_images_mobile);?>" alt="" class="media-object img-responsive">
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-5 magnific-popup-wrap">
                            <div class="form-control">
                                <a class="zooming" href="<?php echo get_image(base_url()."assets/collections/headline/large/".$val->headline_images_child);?>">
                                    <img src="<?php echo get_image(base_url()."assets/collections/headline/large/".$val->headline_images_child);?>" alt="" class="media-object img-responsive">
                                </a>
                            </div>
                        </div>
                    </div>
