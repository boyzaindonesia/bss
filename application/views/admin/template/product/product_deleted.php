...
<div class="the-box no-border">
                            ...
                            <form action="<?php echo !empty($url_form)?$url_form:$own_links;?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                ...
                                <div class="btn-group">
                                    ...
                                    <select name="order_by" class="form-control" onchange="this.form.submit()">
                                        <option value="product_date_istrash-desc" <?php echo ($order_by=='product_date_istrash'&&$order_dir=='desc'?'selected':'') ?> >Date: New to Old</option>
                                        <option value="product_date_istrash-asc" <?php echo ($order_by=='product_date_istrash'&&$order_dir=='asc'?'selected':'') ?> >Date: Old to New</option>
    ...
    <form id="form1" action="<?php echo $url_parent.'/delete_permanent_multi?next='.current_url(); ?>" method="post" enctype="multipart/form-data">
    <div class="table-responsive">
        <table class="table table-th-block table-dark">
            ...
            <thead>
                <tr>
                    <th class="nobr text-center">
                        <div class="checkbox no-margin">
                            <label><input type="checkbox" name="checkallfiles" onclick="check_all_files(this);" value="" data-toggle="tooltip" title="Check All" style="z-index: 999;">&nbsp;</label>
                        </div>
                    </th>
            ...
            if(count($data) > 0){
                ...
                <tr>
                    <td class="nobr text-center">
                        <div class="checkbox">
                            <label><input type="checkbox" name="checked_files[]" value="<?php echo $r->product_id;?>" title="<?php echo $r->product_name;?>"> &nbsp;</label>
                        </div>
                    </td>
