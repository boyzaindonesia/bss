            ...
            <div class="panel-body">
                <div class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="product_awards_name" value="<?php echo isset($val->product_awards_name)?$val->product_awards_name:'';?>" class="form-control" maxlength="255" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Deskripsi</label>
                        <div class="col-sm-9">
                            <textarea name="product_awards_desc" class="form-control no-resize" rows="6"><?php echo isset($val->product_awards_desc)?$val->product_awards_desc:'';?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 magnific-popup-wrap form-preview-images">
                            <div style="position: relative; display: inline-block;">
                                <?php if( isset($val->product_awards_image) && trim($val->product_awards_image)!="" ){ ?>
                                ...
                                <a class="zooming" href="<?php echo get_image(base_url()."assets/collections/awards/large/".$val->product_awards_image);?>">
                                    <img src="<?php echo get_image(base_url()."assets/collections/awards/large/".$val->product_awards_image);?>" alt="" class="media-object img-responsive return-preview-images">
                                </a>
                            </div>
                            <div class="input-group" style="margin-top: 20px;">
                                <span class="input-group-btn">
                                    <span class="btn btn-default btn-file">
                                        Browse… <input type="file" name="product_awards_image" onChange="previewImages(this);" accept="image/*" />
                                    </span>
                                </span>
                    ...
                    <div class="form-group form-action clearfix">
                        <div class="col-sm-9 col-sm-offset-3">
                            <input type="hidden" name="product_awards_id" value="<?php echo isset($val->product_awards_id)?$val->product_awards_id:'';?>" />
                            <input type="submit" name="simpan" class="btn btn-danger" value="Save" />
                            <a href="<?php echo $own_links.($val->product_awards_id!=''?'/view/'.$val->product_awards_id.'-'.changeEnUrl($val->product_awards_name):'');?>"><div class="btn btn-default pull-right">Back</div></a>
                        </div>
                    </div>
                </div>
            </div>
