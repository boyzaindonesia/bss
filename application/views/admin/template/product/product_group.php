            ...
            if(count($data) > 0){
                ...
                <tr data-itemid="<?php echo $r->product_group_id;?>">
                    ...
                    <td class="magnific-popup-wrap">
                        <a class="zooming" href="<?php echo get_image(base_url()."assets/collections/product/small/".get_cover_product_group($r->product_group_id));?>"><img src="<?php echo get_image(base_url()."assets/collections/product/small/".get_cover_product_group($r->product_group_id));?>" class="avatar mfp-fade"></a>
                    </td>
