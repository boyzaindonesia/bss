                    ...
                    <table class="table table-th-block no-margin r-border">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="nobr">:
                                    <?php
                                    $get_payment_method = get_payment_method($orders_payment->orders_payment_method);
                                    echo $get_payment_method->payment_method_name;
                                    ?>
                                </td>
                            </tr>
                            <tr>
                ...
                <div class="panel-body">
                    <table class="table table-th-block no-margin">
                        ...
                        <tbody>
                            ...
                            <?php $get_orders_courier = get_orders_courier($val->orders_courier_id); ?>
                            <tr>
                                <td class="nobr">Courier</td>
                                <td class="">: <?php echo $get_orders_courier->orders_courier_name ?></td>
                            </tr>
                            <tr>
                                <td class="nobr">Courier services</td>
                                <td class="">: <?php echo $get_orders_courier->orders_courier_service ?></td>
                            </tr>
                            <tr>
                    ...
                    <table class="table table-th-block no-margin">
                        ...
                        foreach ($timestamp_desc as $key => $value) { ?>
                            <tr>
                                ...
                                <td class="nobr"><span class="form-control"><?php echo convDateTimeFullEng($value->date) ?></span></td>
                            </tr>
                        <?php } ?>
                        </tbody>
                    </table>
