...
<div class="the-box no-border">
    ...
    <div class="btn-toolbar toolbar-btn-action">
        ...
        <div class="btn-group pull-right">
            <div class="btn btn-info btn-process-multiple" data-url="<?php echo base_url().'admin/transaction_process/save_multiple_confirm_orders' ?>"><i class="fa fa-send"></i> Proses Pesanan ( 0/0 )</div>
        </div>
        <div class="btn-group pull-right">
    ...
    <div class="panel panel-danger mb-10">
        ...
        <div id="panel-collapse-3" class="collapse in" style="height: auto;">
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-8">
                        <form id="formUpload" action="<?php echo base_url().'admin/transaction_process/upload_new_orders'?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <form action="<?php echo !empty($url_form)?$url_form:$own_links;?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                ...
                                <div class="btn-group">
                                    ...
                                    <select name="orders_status" class="form-control" onchange="this.form.submit()">
                                        ...
                                        foreach ($get_orders_status as $k => $v) { ?>
    ...
    <div class="relative clearfix">
        <?php
        $timestamp    = timestamp();
        $statistic    = get_orders_report_by_date($timestamp);
        $arrStatistic = convObjToArray($statistic);
        ?>
        <div class="row">
            <div class="col-sm-3" style="padding:0 3px;">
                <ul class="list-group">
                    <li class="list-group-item"><?php echo $arrStatistic[0]->name ?><span class="badge badge-success"><?php echo $arrStatistic[0]->qty ?> order</span></li>
                    <li class="list-group-item"><?php echo $arrStatistic[1]->name ?><span class="badge badge-success"><?php echo $arrStatistic[1]->qty ?> produk</span></li>
                    <li class="list-group-item"><?php echo $arrStatistic[2]->name ?><span class="badge badge-success"><?php echo $arrStatistic[2]->qty ?> item</span></li>
                </ul>
            </div>
            <div class="col-sm-3" style="padding:0 3px;">
                <ul class="list-group">
                    <li class="list-group-item"><?php echo $arrStatistic[4]->name ?><span class="badge badge-success"><?php echo convertRp($arrStatistic[4]->price) ?></span></li>
                    <li class="list-group-item"><?php echo $arrStatistic[5]->name ?><span class="badge badge-success"><?php echo convertRp($arrStatistic[5]->price) ?></span></li>
                    <li class="list-group-item"><?php echo $arrStatistic[6]->name ?><span class="badge badge-success"><?php echo convertRp($arrStatistic[6]->price) ?></span></li>
                    <li class="list-group-item"><?php echo $arrStatistic[9]->name ?><span class="badge badge-success"><?php echo convertRp($arrStatistic[9]->price) ?></span></li>
                </ul>
            </div>
            <div class="col-sm-3" style="padding:0 3px;">
                <ul class="list-group">
                    <li class="list-group-item"><?php echo $arrStatistic[7]->name ?><span class="badge badge-success"><?php echo convertRp($arrStatistic[7]->price) ?></span></li>
                    <li class="list-group-item"><?php echo $arrStatistic[11]->name ?> (<?php echo $arrStatistic[11]->qty ?>)<span class="badge badge-success"><?php echo convertRp($arrStatistic[11]->price) ?></span></li>
                    <li class="list-group-item"><?php echo $arrStatistic[12]->name ?> (<?php echo $arrStatistic[12]->qty ?>)<span class="badge badge-success"><?php echo convertRp($arrStatistic[12]->price) ?></span></li>
                    <?php
                    $ongkir_lain = 0;
                    $ongkir_qtylain = 0;
                    $arrOngkir = array(13,14,15,16,17,18,19);
                    foreach ($arrOngkir as $n) {
                        $ongkir_lain += $arrStatistic[$n]->price;
                        $ongkir_qtylain += $arrStatistic[$n]->qty;
                    }
                    ?>
                    <li class="list-group-item">Ongkir Lainnya (<?php echo $ongkir_qtylain ?>)<span class="badge badge-success"><?php echo convertRp($ongkir_lain) ?></span></li>
                </ul>
            </div>
            <div class="col-sm-3" style="padding:0 3px;">
                <ul class="list-group">
                    <li class="list-group-item"><?php echo $arrStatistic[21]->name ?> (<?php echo $arrStatistic[21]->qty ?>)<span class="badge badge-success"><?php echo convertRp($arrStatistic[21]->price) ?></span></li>
                    <li class="list-group-item"><?php echo $arrStatistic[22]->name ?> (<?php echo $arrStatistic[22]->qty ?>)<span class="badge badge-success"><?php echo convertRp($arrStatistic[22]->price) ?></span></li>
                    <li class="list-group-item"><?php echo $arrStatistic[23]->name ?> (<?php echo $arrStatistic[23]->qty ?>)<span class="badge badge-success"><?php echo convertRp($arrStatistic[23]->price) ?></span></li>
                    <?php
                    $ship_qty_lain   = 0;
                    $ship_price_lain = 0;
                    $arrShip = array(20,24,25,26,27,28,29,20);
                    foreach ($arrShip as $n) {
                        $ship_qty_lain   += $arrStatistic[$n]->qty;
                        $ship_price_lain += $arrStatistic[$n]->price;
                    }
                    ?>
                    <li class="list-group-item">Terjual Lainnya (<?php echo $ship_qty_lain ?>)<span class="badge badge-success"><?php echo convertRp($ship_price_lain) ?></span></li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="the-box no-border">
    ...
    <div class="btn-group">
        <div class="btn btn-info btn-test-ajax" data-url="https://www.tokopedia.com/pixelten"><i class="fa fa-copy"></i> Test Ajax</div>
    </div>
    <div id="result_lazada" class="result_lazada">
        aaa
...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).on('click', '.btn-test-ajax', function(e){
            e.preventDefault();
            var $this   = $(this);
            var dataUrl = $this.attr('data-url');

            var idFrame = "frameScrape1";
            var frame = '<iframe id="'+idFrame+'" src="'+dataUrl+'" height="200"></iframe>';
            $('body').append(frame);
            document.getElementById(idFrame).onload=function(){
                console.log('loaded');
                setTimeout(function(){
                    // var doc = frame[0].contentWindow.document;

                    // var editFrame = document.getElementById(idFrame);
                    // var doc = $(editFrame).contents().find("html").html();
                    // $('#result_lazada').html(doc);

                    var iframe= $('#frameScrape1')[0];
                    var iframewindow= iframe.contentWindow? iframe.contentWindow : iframe.contentDocument.defaultView;

                    // var iframeBody = $(frames["frameScrape1"].window.document).contents().find("body");
                    console.log(iframewindow.html());

                    // var $body = $('#result_lazada',doc);
                    // var containter = $('#'+idFrame).find('body');
                    // var containter = document.getElementById(idFrame).find('body');
                    // alert(containter.html());
                }, 1000);
            };
    ...
    function makeCorsRequest() {
        ...
        var url = 'https://www.tokopedia.com/pixelten';
    ...
    $(document).ready(function() {
        // makeCorsRequest();
        // $.get("https://api.sellercenter.lazada.co.id/?Action=GetOrders&CreatedAfter=2014-02-25T23%3A46%3A11%2B00%3A00&Format=json&Timestamp=2018-06-24T09%3A09%3A35%2B00%3A00&UserID=khairunnisa.febriani15%40gmail.com&Version=1.0&Signature=197ed2948e44b7cc0e396b7443f75b30e59a00deab83a0c16a22842f46900368", function(data, status){
        //     alert("Data: " + data + "\nStatus: " + status);
        // });
        // $.ajax({
        //     type: 'POST',
        //     url: "https://api.sellercenter.lazada.co.id?CreatedAfter=2014-02-25T23%3A46%3A11%2B00%3A00&Format=json&Timestamp=2018-06-24T08%3A54%3A25%2B00%3A00&UserID=khairunnisa.febriani15%40gmail.com&Version=1.0&Signature=0972009ef9cb4a27e8bb108e30b3fe4b69f2012d8b4994df29491d432bac9813",
        //     data: {'Action':'GetOrders','thisAction':'save'},
        //     async: false,
        //     cache: false,
        //     dataType: 'json',
        //     success: function(data){
        //         $('#result_lazada').html(data);
        //     },
        ...
        $(document).on('click', '.btn-popup', function(e){
            ...
            if($thisVal != ''){
                setTimeout(function(){
                    $.ajax({
                        type: 'POST',
                        url: MOD_URL+'admin/transaction_form/form_label',
                    ...
                    success: function(data){
                        if(data.err == false){
                            ...
                            function (dismiss) {
                                ...
                                if(price_product > 0){
                                    $('#form1 table tr[data-id='+orders_id+'] .price_product').html("Harga: "+convertRp(price_product));
                                } else {
                                    $('#form1 table tr[data-id='+orders_id+'] .price_product').html("");
                                }
                                if(price_shipping > 0){
                                    $('#form1 table tr[data-id='+orders_id+'] .price_shipping').html("Ongkir: "+convertRp(price_shipping));
                                } else {
                                    $('#form1 table tr[data-id='+orders_id+'] .price_shipping').html("");
                                }
                                if(price_insurance > 0){
                                    $('#form1 table tr[data-id='+orders_id+'] .price_insurance').html("Asuransi: "+convertRp(price_insurance));
                                } else {
                                    $('#form1 table tr[data-id='+orders_id+'] .price_insurance').html("");
                                }
